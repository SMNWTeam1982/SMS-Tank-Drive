...
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    ...
    Logger.recordMetadata("ProjectName", "SMS Tank Drive Demo Bot");
  
    if (isReal()) {
      Logger.addDataReceiver(new NT4Publisher()); // Publish Data exclusively to NetworkTables
    } else if (OperatorConstants.replayLogs) {
      ...
      Logger.addDataReceiver(new WPILOGWriter(LogFileUtil.addPathSuffix(logPath, "_replay"))); // Save Sim outputs to seperate log file
    } else {
      setUseTiming(false); // Run as fast as possible
